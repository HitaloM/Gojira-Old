...
@Gojira.on_callback_query(filters.regex(r"^suggestions manga (?P<page>\d+)"))
@use_chat_language()
async def manga_suggestions(bot: Gojira, callback: CallbackQuery):
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"suggestions manga {pg}",
            )
